...
//                    <input type="text" placeholder='Enter Your Email' className='border w-full py-1 px-4 mt-1 rounded-md' required
//                    value = {email}
//                    onChange={(e)=> setEmail(e.target.value)}/> 
//                 </div>
//                  <div>
//                    <p className='text-sm font-semibold'>Password</p>
//                    <input type="password" placeholder='Enter Your password' className='border w-full py-1 px-4 mt-1 rounded-md' required
//                    value = {password}
