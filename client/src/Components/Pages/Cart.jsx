...
const Cart = () => {
  ...
  const orderCount = useSelector((state) => state.orebi.orderCount);
  ...
  dispatch(deleteItem(id)); // pass the _id string
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <Container className="py-8">
          <div className="flex flex-col space-y-2">
            <Link to={"/cart"} className="text-3xl font-bold text-gray-900">Shopping Cart</Link>
        ...
        {products.length > 0 ? (
          ...
          >
            <div className="max-w-md mx-auto">
              <img
                className="w-32 h-32 mx-auto mb-6 object-cover bg-gray-100 rounded-full"
                src={emptyCart}
                alt="Empty Cart"
              />
              ...
              <Link to="/shop">
                <button className="bg-gray-900 text-white px-8 py-4 rounded-md hover:bg-gray-800 transition-colors font-medium text-xl">
                  🛍️ Start Shopping
                </button>
              </Link>
            </div>
